...
SOLVENTS = ['NMP', 'DMAc', 'toluene', 'DMF', 'N-methyl-2-pyrrolidone', 'dimethylformamide', 'dimethyl formamide', 'dimethylacetamide', 'dimethyl acetamide', 'm-xylene']
MATERIAL_CATEGORIES = ['composite', 'additive', 'plasticiz', 'quaterni', 'crosslink', 'cross-link', 'graft', 'doping', 'doped', 'dopant', 'hydrogel', 'oligomer', 'star', 'filler', 'initia', 'catalys', 'inhib', 'oxidiz', 'solven', 'ligan']
